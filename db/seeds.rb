first_user = User.create(name: "jorge",
                         provider: "github",
                         uid: "203489",
                         nickname: "dabomb",
...
second_user = User.create(name: "horace",
                         provider: "github",
                         uid: "123456",
                         nickname: "speedy",
...
third_user = User.create(name: "steve",
                         provider: "github",
                         uid: "567890",
                         nickname: "javablip",
                         email: "travis@example.com",
...
Goal.create(user_id: first_user,
...
Goal.create(user_id: second_user,
...
Goal.create(user_id: third_user,
            title: "wow such code",
...
Commit.create(user_id: first_user,
...
Commit.create(user_id: second_user,
              message: "create seeds file",
              date: Date.current.advance(days: 10),
...
Commit.create(user_id: third_user,
              message: "create seeds file",
              date: Date.current.advance(days: 10),
